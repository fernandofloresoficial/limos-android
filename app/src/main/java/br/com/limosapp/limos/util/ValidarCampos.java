...
public class ValidarCampos {
    ...
    public boolean validarNotNull(View pView, String pMessage) {
    ...
    public boolean validarTelefone(String telefone) {
        if (TextUtils.isEmpty(telefone) || telefone.length()!= 11) {
            return false;
        } else{
